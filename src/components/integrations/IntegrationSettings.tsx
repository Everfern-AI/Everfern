                                        ...
                                        <div style={{ padding: 24 }}>
                                            {selectedIntegration === 'telegram' && (
                                                <TelegramConfig
                                                    ...
                                                    onSave={async (telegramConfig, closeAfterSave = false) => {
                                                        const newConfig = {
                                                            ...config,
                                                            telegram: {
                                                                ...config.telegram,
                                                        ...
                                                        setConfig(newConfig);
                                                        await (window as any)?.electronAPI?.integration?.saveConfig?.(newConfig);
                                            ...
                                            {selectedIntegration === 'discord' && (
                                                <DiscordConfig
                                                    ...
                                                    onSave={async (discordConfig, closeAfterSave = false) => {
                                                        const newConfig = {
                                                            ...config,
                                                            discord: {
                                                                ...config.discord,
