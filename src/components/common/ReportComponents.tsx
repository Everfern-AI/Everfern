        ...
        <AnimatePresence>
            {isOpen && (
                <motion.div
                    ...
                    className="fixed top-3 right-3 bottom-3 w-[65vw] max-w-[1100px] bg-[var(--color-bg-surface)] border border-[var(--color-border)] rounded-3xl shadow-[−10px_0_40px_rgba(0,0,0,0.08),0_10px_30px_rgba(0,0,0,0.03)] z-1000 flex flex-col overflow-hidden glossy"
                >
                    {/* Header */}
