        ...
        <AnimatePresence>
            {isVisible && status !== 'idle' && (
                <motion.div
                    ...
                    className="fixed overflow-hidden rounded-[24px] border border-neutral-200 bg-white shadow-2xl backdrop-blur-md dark:border-white/10 dark:bg-[#0A0A0A] text-black dark:text-white glossy"
                    style={{
                        bottom: '24px',
                        right: '24px',
                        width: '360px',
