...
exports.runInLinuxVM = runInLinuxVM;
exports.isLinuxVMAvailable = isLinuxVMAvailable;
exports.ensureDockerContainer = ensureDockerContainer;
exports.translateWindowsPathToLinux = translateWindowsPathToLinux;
exports.translateMacOSPathToDocker = translateMacOSPathToDocker;
exports.translateLinuxPathToHost = translateLinuxPathToHost;
 ...
 */
async function runInLinuxVM(command, cwd) {
 ...
 */
async function runInWSL(command, cwd) {
 ...
 */
async function runInDocker(command, cwd) {
 ...
 */
async function runNatively(command, cwd) {
    // If a working directory is specified, prepend cd command
    let fullCommand = command;
    if (cwd) {
 ...
 */
async function isLinuxVMAvailable() {
    const platform = process.platform;
    try {
        if (platform === 'win32') {
            try {
 ...
 */
function translateWindowsPathToLinux(windowsPath) {
 ...
 */
function translateMacOSPathToDocker(macOSPath) {
 ...
 * - /host/Users/... → /Users/...
 */
function translateLinuxPathToHost(linuxPath) {
